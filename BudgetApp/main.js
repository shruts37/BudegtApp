...
const itemCtrl = (function () {
    //item contructor
    const Item = function (id, title, description, amount) {
        this.id = id;
    ...
    return {
        ...
        addMoney: function (title, description, amount) {
            //create random id
            let ID = itemCtrl.createID();
            //create new item
            newMoney = new Item(ID, title, description, amount);
...
const UICtrl = (function () {
    ...
    return {
        ...
        getTitleInput: function () {
            return {
                titleInput: document.querySelector(UISelectors.title).value
            }
        },
...
const App = (function () {
    ...
    const addIncome = function () {
        ...
        const title = UICtrl.getTitleInput();

        //if inputs are not empty
        if (description.descriptionInput !== '' && amount.amountInput !== '' && title.titleInput !== '') {
            //add new item
            const newMoney = itemCtrl.addMoney(title.titleInput, description.descriptionInput, amount.amountInput);
